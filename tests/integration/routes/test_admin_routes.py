...
class TestAdminRoutes:
    ...
    @pytest.fixture
    def admin_authenticated_client(self, app, admin_user):
    ...
    def test_admin_dashboard_authorized(self, admin_authenticated_client):
    ...
    def test_admin_dashboard_unauthenticated(self, test_client):
    ...
    def test_analytics_overview_authorized(self, admin_authenticated_client, session, user, chat):
    ...
    def test_analytics_overview_empty_data(self, admin_authenticated_client, session):
    ...
    def test_analytics_overview_unauthorized(self, authenticated_client):
        """Test that regular users cannot get analytics overview data."""
        response = authenticated_client.get("/api/analytics/overview")
        assert response.status_code == 403

    def test_analytics_overview_unauthenticated(self, test_client):
    ...
    def test_chat_activity_authorized(self, admin_authenticated_client, session, user, chat):
    ...
    def test_chat_activity_empty_data(self, admin_authenticated_client, session):
    ...
    def test_chat_activity_unauthorized(self, authenticated_client):
        """Test that regular users cannot get chat activity data."""
        response = authenticated_client.get("/api/analytics/chat-activity")
        assert response.status_code == 403

    def test_chat_activity_unauthenticated(self, test_client):
    ...
    def test_user_activity_authorized(self, admin_authenticated_client, session, user, chat):
    ...
    def test_user_activity_empty_data(self, admin_authenticated_client, session):
    ...
    def test_user_activity_unauthorized(self, authenticated_client):
        """Test that regular users cannot get user activity data."""
        response = authenticated_client.get("/api/analytics/user-activity")
        assert response.status_code == 403

    def test_user_activity_unauthenticated(self, test_client):
